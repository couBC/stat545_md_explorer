...
>>>>>>> de937534fd869a2c71d5716c4f89a00ebbcbcc92
---
...
```{r}
plot1 <- ggplot(mtcars, aes(hp, wt)) + 
    geom_point()
ggsave("my_plot.png", plot1)

#its better to save iwth ggsave as it is reproducible and modifiable that way rather than downloading it from the console/plots
```
...
#1:10 * 10 makes the y axis every 10 years. Even though 90 and 100 are specified they don't show up becAUSE there are no data points for 90 etc.,
```
