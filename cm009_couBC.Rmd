...
---
#read_csv keeps things as characters rather than factors like read.csv
```{r}
...
#paste puts two things together with a space in between. Or you can do paste0 for no space
...
#All these codes do the same thing:
```{r}
...
do.call is a base R function, not tidyverse

do.call(f,l) is same as f(l1, l2, l3) 
```{r}
...
```{r}
#Example of creating a new column to add
...
```{r}
#returns all possible combinations of the variables even if it doesn't exist in the data frame
