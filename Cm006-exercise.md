...
title: "cm006 Exercises: Exploring Geometric Objects" output: html\_notebook editor\_options: chunk\_output\_type: inline ---
...
having aes() is critical! see below as no specifying aes() makes it not work.
=============================================================================

Other option: see below also works
==================================
...
boxplots are useful for one numeric variable across cateogires (e.g., lifeExp by country/continent etc.,)
=========================================================================================================
...
violin plots are great. Violin plots are kernel density plots put on side
=========================================================================
...
1.  How does the grammar differ from a box plot or violin plot?
    -   ANSWER: \#try jitter to violin plot -great visiaul
...
![](Cm006-exercise_files/figure-markdown_github/unnamed-chunk-20-1.png) \#this is even better because it gives you an idea about the total number of datapoints (lets you see all the info versus pinhead plots or boxplots etc.,), also lets you see outliers
...
piping doesn't work in ggplot, so use "+" sign
==============================================
...
![](Cm006-exercise_files/figure-markdown_github/unnamed-chunk-22-2.png)
...
**Uses of bar plots**: Get a sense of relative quantities of categories, or see the probability mass function of a categorical random variable. | **aesthetic mapping** | 'x | **geometric object** | | | scale | | | statistical transform | | | coordinate system | | | facetting | |
