...
4. How does the grammar differ from a box plot or violin plot?
    - ANSWER: 
#try jitter to violin plot -great visiaul
...
```
#this is even better because it gives you an idea about the total number of datapoints (lets you see all the info versus pinhead plots or boxplots etc.,), also lets you see outliers 
